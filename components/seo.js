...
export const metadata = {
  title: "Shababul Alam's portfolio",
  description: "PWA portfolio built with Next 13",
  generator: "Next.js",
  manifest: "/manifest.json",
  keywords: ["ShababulAlam", "shababul", "alam", "shababulalam", "sababmalam"],
  authors: [
    {
      name: "Shababul Alam",
      url: "https://www.linkedin.com/in/shababulalam/",
    },
  ],
  viewport:
