...
const createHighlightsFeed = articles => {
  const highlightsFeed = new RSS({
    title: "Shababul Alam's Highlights",
    site_url: "https://shababulalam.com/highlights",
    feed_url: "https://shababulalam.com/highlightsfeed.xml",
    image_url: "https://shababulalam.com/images/meta/highlightsog.png",
    language: "en",
  })
  ...
  articles.results.forEach(article => {
    ...
    const description = `<a href="https://shababulalam.com/highlights#${articleID}"> <strong>Read ${numHighlights} ${highlightText} →</strong> <br></br><br></br> <a href="${source}">Original article </a> from ${sourceAuthor}`
    ...
    if (numHighlights != 0) {
      highlightsFeed.item({
        ...
        url: `https://shababulalam.com/highlights#${articleID}`,
      })
    }
  })
